...
<tr> <td> Eksempel </td> <td> Der kan eksempelvis være (men er ikke begrænset til): 
...
MED-organisationen, som repræsenterer arbejdet med arbejdsmiljø </td> </tr>
<tr> <td> Profil </td> <td> Organisatorisk struktur </td> </tr>
</table>
...
Ikrafttrædelse (gyldighed) skal kunne specificeres som:
o	Helt åbent (ingen fra og ingen til)
o	Halvåbent (fra et givet tidspunkt eller til et givet tidspunkt)
o	Lukket (kun mellem to tidspunkter)
...
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Organisationsstandarden kan beskrive ændringer i organisationen. 
o	Organisationsstandarden kan beskrive planlagte ændringer, som skal effektueres på et givent tidspunkt.
o	Organisationsstandarden kan beskrive og håndtere tidligere aktive versioner af organisationen. </td> </tr>
</table>
...
o	Helt åbent (ingen fra og ingen til)
o	Halvåbent (fra et givet tidspunkt eller til et givet tidspunkt)
Lukket (kun mellem to tidspunkter </td> </tr>
...
<tr> <td> Eksempel </td> <td>  </td> </tr>
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Med organisationsstandarden kan angives type for organisationen
o	Angivelsen af type er samordnet med eksisterende beskrivelser af Virksomhed, Myndighed og Foreninger. </td> </tr>
</table>
...
<tr> <td> Eksempel </td> <td>  </td> </tr>
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Organisationsstandarden kan angive fysiske adresser i overensstemmelse med adresser i DAR. 
o	Organisationsstandarden kan håndtere udenlandske adresser. </td> </tr>
</table>
...
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Organisationsstandarden kan beskrive forskellige typer af kontaktoplysninger
o	Der kan tilknyttes åbningstider til kontaktoplysningerne. </td> </tr>
</table>
...
•	<tr> <td> Eksempel </td> <td> Besøgsadresse
•	Telefon
•	Mail
•	DigitalPost
•	Vareindlevering
...
<tr> <td> Beskrivelse </td> <td> Organisationer indgår i forskellige typer af relationer med hinanden. Relationerne kan være i form af:
o	organisatoriske samarbejder, hvor organisationer går sammen om eksempelvis en specifik opgave
o	under- og overordnelsesforhold, hvor et kontor er underordnet i forhold til en afdeling
medarbejder til medarbejder-relationer </td> </tr>
...
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Organisationsstandarden kan beskrive samarbejde mellem organisationer
o	Organisationsstandarden kan beskrive, at en organisation er i et under- eller overordnelsesforhold til en anden organisation.
o	Organisationsstandarden kan beskrive, at organisationer kan relateres sideordnet. 
Organisationsstandarden kan beskrive interne relationer mellem organisationsmedlemmer. </td> </tr>
</table>
...
- Et medlem kan være "mentor for" et andet medlem 
- Et medlem kan være "ansvarlig for" andet medlem (især hvis det er en NPE (NonPersonEntity) 
- Et medlem kan være "chef for" et andet medlem 
- Et medlem kan være "tillidsrepræsentant for" et andet medlem </td> </tr>
<tr> <td> Profil </td> <td> Medlemskab og personer </td> </tr>
</table>
...
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Med organisationsstandarden kan beskrives de funktioner, som organisationen udfører, så det er tydeligt, hvem der arbejder med hvad. 
o	De forskellige arbejdsopgaver eller funktioner kan knyttes til en eller flere organisationsenheder. </td> </tr>
</table>
...
o	<tr> <td> Resultat / Acceptkriterier </td> <td> Organisationsstandarden kan beskrive, hvordan personer er tilknyttet organisationer og organisationsenheder. 
o	Organisationsstandarden skal kunne håndtere, at personer kan have flere tilknytninger til en organisation, fx i form af flere ansættelsesforhold. 
o	Organisationsstandarden skal også kunne rumme markering af, om et tilknytningsforhold er rettighedsbærende i forhold til organisationens it-systemer. </td> </tr>
</table>
...
•	<tr> <td> Eksempel </td> <td> Køre truck
•	Autorisere rejsebilag
•	Godkende tidsregistrering
•	… </td> </tr>
<tr> <td> Profil </td> <td> Opgaver </td> </tr>
</table>
...
Tabel 17 Fælles semantisk ramme
